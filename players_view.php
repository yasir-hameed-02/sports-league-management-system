...
SELECT 
    ...
    seasons.SeasonYear
FROM matches
LEFT JOIN teams AS home ON matches.HomeTeamID = home.TeamID
LEFT JOIN teams AS away ON matches.AwayTeamID = away.TeamID
LEFT JOIN venues ON matches.VenueID = venues.VenueID
LEFT JOIN seasons ON matches.SeasonID = seasons.SeasonID
");
?>
...
<div class="container">
<h2>⚽ Matches List</h2>
<a class="btn add" href="add_match.php">➕ Add Match</a>
<br><br>
...
<tr>
    ...
    <td>
        <a class="btn edit" href="edit_match.php?id=<?= $row['MatchID'] ?>">Edit</a>
       <a class="btn delete" href="#" onclick="showModal('delete_match.php?id=<?= $row["MatchID"] ?>'); return false;">🗑️ Delete</a>
</tr>
<?php } ?>
</table>
</div>
