...
SELECT teams.*, coaches.CoachName 
FROM teams 
...
<a class="btn add" href="add_team.php">➕ Add Team</a>
...
<tr>
    ...
    <td><?= $row['TeamName'] ?></td>
    <td><?= $row['City'] ?></td>
    <td><?= $row['CoachName'] ?? 'No Coach' ?></td>
    <td>
        <a class="btn edit" href="edit_team.php?id=<?= $row['TeamID'] ?>">✏️ Edit</a>
        <a class="btn delete" href="#" onclick="showModal('delete_team.php?id=<?= $row['TeamID'] ?>'); return false;">🗑️ Delete</a>
    </td>
</tr>
<?php } ?>
