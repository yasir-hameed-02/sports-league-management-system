<?php
include "db.php";
$result = mysqli_query($conn, "SELECT * FROM coaches");
?>
...
<div class="container">
<h2>🧑‍💼 Coaches List</h2>
<a class="btn add" href="add_coach.php">➕ Add Coach</a>
<br><br>
...
<tr>
    ...
    <td>
        <a class="btn edit" href="edit_coach.php?id=<?= $row['CoachID'] ?>">✏️ Edit</a>
       <a class="btn delete" href="#" onclick="showModal('delete_coach.php?id=<?= $row['CoachID'] ?>'); return false;">🗑️ Delete</a>
    </td>
</tr>
<?php } ?>
</table>
