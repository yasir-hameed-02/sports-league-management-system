...
<a class="btn add" href="add_player.php">➕ Add Player</a>
<br><br>
...
<tr>
    ...
    <td><?= $row['Age'] ?></td>
    <td><?= $row['Position'] ?></td>
    <td><?= $row['TeamName'] ?? 'No Team' ?></td>
    <td>
        <a class="btn edit" href="edit_player.php?id=<?= $row['PlayerID'] ?>">✏️ Edit</a>
        <a class="btn delete" href="#" onclick="showModal('delete_player.php?id=<?= $row['PlayerID'] ?>'); return false;">🗑️ Delete</a>
    </td>
</tr>
<?php } ?>
