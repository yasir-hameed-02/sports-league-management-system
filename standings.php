...
<div class="container">
<h2>📅 Seasons List</h2>
<a class="btn add" href="add_season.php">➕ Add Season</a>
<br><br>
...
<tr>
    ...
    <td><?= $row['EndDate'] ?></td>
    <td>
        <a class="btn edit" href="edit_season.php?id=<?= $row['SeasonID'] ?>">Edit</a>
        <a class="btn delete" href="#" onclick="showModal('delete_season.php?id=<?= $row["SeasonID"] ?>'); return false;">🗑️ Delete</a>
    </td>
</tr>
<?php } ?>
</table>
